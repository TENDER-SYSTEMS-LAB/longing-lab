...
v5 — FOUR WAVES CARRY MEASURED DATES IN AT LEAST ONE MARKET; THREE ARE PLACEHOLDERS.

Mobile and broadband are dated in all three markets from the WDI spine, as in
v4. Smartphones are dated in Japan (MIC household ownership, 2010-2023) and the
United States (Pew adult ownership, 2011-2025); the social web in Japan (OECD
D1B_I, individuals 16-74 using social networking sites in the last three months,
2012-2024, ceiling fixed at 100) and the United States (Pew, share of internet
users using social media, 2005-2015). Korea keeps its placeholder for both: no
smartphone series was obtained, and its OECD social-networking series begins
above half its ceiling, so it bounds the midpoint (at or before 2005) without
containing it. A wave's width is the median of the fitted scales of the markets
that were measured. Dial-up, messaging and AI keep placeholder dates; the
sourcing round found no measured three-country series for them. The measured
boundary stays at week 1461. Everything else is unchanged from v3.
"""
...
WAVES = [("dialup",     10,  -40,  -80, 260, 0.9,   1.00,  None),  # placeholder
         ...
         ("socialweb", 195, 1032,  660, 300, 1.1,   1.40,   182),  # KR placeholder (bound <=530); JP OECD D1B_I; US Pew
         ("smartphone",690,  887,  868, 240, 1.6,   0.55,   118),  # KR placeholder; JP MIC household; US Pew adults
...
def tests():
    ...
    print("\n" + "=" * 76)
    print("LONGING RESEARCH — DEC-008 / DEC-009 / technology-waves — v5, four waves partly measured")
    print("=" * 76)
