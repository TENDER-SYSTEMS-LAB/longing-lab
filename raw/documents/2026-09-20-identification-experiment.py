"""LONGING RESEARCH — identification experiment on the generated world.
...
HARNESS = "raw/documents/2026-09-20-loop-simulation-harness-v3.py"
...
def main(seeds=(11, 12, 13, 14, 15), truths=(3, 6, 9, 13)):
    print("=" * 76)
    print("LONGING RESEARCH — identification experiment on the v3 world")
    print("=" * 76)
