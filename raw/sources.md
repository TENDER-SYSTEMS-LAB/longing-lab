...
| `SRC-2026-09-21-weights-in-the-definition-exposures-measured` | [raw/conversations/2026-09-21-weights-in-the-definition-exposures-measured.md](conversations/2026-09-21-weights-in-the-definition-exposures-measured.md) | conversation | 2026-09-21 | user-originated | `c3177b67c4431c677aa8d11675fd29354ab74321` | 2026-09-21 | promoted as an evolution of DEC-014; the per-security ontology's two weights are the security's definition and its two exposures are measured per era, with the condition that the definitions be decided carefully and precisely; the three ambiguous cases are `llm-proposed` |
| `SRC-2026-09-21-weights-sum-to-one-and-conditional-revision` | [raw/conversations/2026-09-21-weights-sum-to-one-and-conditional-revision.md](conversations/2026-09-21-weights-sum-to-one-and-conditional-revision.md) | conversation | 2026-09-21 | user-originated | `c6f7992b8f091756c7012c64d89933f9469bd0d6` | 2026-09-21 | promoted as an evolution of DEC-014; the weights are a pair summing to one and may be revised only under conditions fixed in advance; the weight-setting procedure goes to an LLM round for the user's final call, and exposure sources are to be collected widely then narrowed by quantity and quality |
| `SRC-2026-09-22-revision-conditions-a-and-b` | [raw/conversations/2026-09-22-revision-conditions-a-and-b.md](conversations/2026-09-22-revision-conditions-a-and-b.md) | conversation | 2026-09-22 | user-originated | `bc3aac65cd75cc0864dac8cca9a191bb3b296231` | 2026-09-22 | promoted as an evolution of DEC-014; a security's weights may be revised when its definition changes or when its weights disagree across the three markets; the residual-threshold condition is rejected; two round prompts requested |
| `SRC-2026-09-22-weight-setting-procedure-prompt` | [raw/documents/2026-09-22-weight-setting-procedure-prompt.md](documents/2026-09-22-weight-setting-procedure-prompt.md) | document | 2026-09-22 | llm-proposed | `d5c0f4759eefc277fa69a7b7448abebb699fd51b` | 2026-09-22 | registered; the round prompt for the weight-setting procedure, drafted at the user's request and to be run by the user; fixed context carries DEC-014 and its three evolutions |
| `SRC-2026-09-22-exposure-sources-brainstorm-prompt` | [raw/documents/2026-09-22-exposure-sources-brainstorm-prompt.md](documents/2026-09-22-exposure-sources-brainstorm-prompt.md) | document | 2026-09-22 | llm-proposed | `a00a45dd4cf4b557b5b2b35cca376b033e21796a` | 2026-09-22 | registered; the collection-round prompt for per-era exposure sources, drafted at the user's request and to be run by the user; LETTER is the worked case |
