...
> 일단 그럼 순서 제약을 유지하되, 나중에 기록을 보고 고치는걸로 하자.
...
3. **The choice is provisional.** It stands until the record — the generated history, its bands and its analysts' readings — has been looked at, and is then corrected if the record says so. What in the record would prompt the correction is not stated.

A second wording of the same turn reached a parallel session and is registered as [[SRC-2026-09-20-order-constraint-retained]]:

> 일단 그럼 순서 제약을 유지하자. 내가 나중에 기록보고 순서 제약을 해제 하던지 고려해볼게

It reinforces parts 2 and 3. Its verb is *consider lifting* rather than *correct*, which fixes what the later reading is for: the constraint itself, not the decision to let analysts carry an order.
...
- [[SRC-2026-09-20-analyst-orders-inside-the-constraint]] — [raw/conversations/2026-09-20-analyst-orders-inside-the-constraint.md](../../raw/conversations/2026-09-20-analyst-orders-inside-the-constraint.md); the decision
...
- [[SRC-2026-09-20-order-constraint-retained]] — [raw/conversations/2026-09-20-order-constraint-retained.md](../../raw/conversations/2026-09-20-order-constraint-retained.md); the same turn in a second wording, the constraint kept and its lifting left for later
