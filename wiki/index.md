...
- [[data-sources]] — Selected fictional historical-data basis, layered state and information, and a driver measured where national statistics exist and extrapolated beyond, now tested against what is published and with the nine WDI series in hand, plus a proposed design for measuring enablement apart from substitution, to be redrawn now the channel counts judgment · `working` (2026-09-21)
