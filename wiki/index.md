...
- [[technology-waves]] — Arrival raises what substitution later takes, so every wave is a rise followed by a decline; thirty years 1996–2026, a connection-creating coefficient per wave, and a driver measured where statistics exist, with the WDI spine collected and a boundary that is one per series · `working` (2026-09-20)
...
- [[identification-experiment]] — The fourth round's Section 7 procedure run on the v3 world: the handover through the interaction block, a recovered count that saturates near nine, a promotion gate calibrated on a planted null, cross-market transportability, and the order's stake measured — no factor named, nothing calibrated · `working` (2026-09-20)
