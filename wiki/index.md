...
- [[technology-waves]] — Arrival raises what substitution later takes, so every wave is a rise followed by a decline; thirty years 1996–2026, a connection-creating coefficient per wave, and a driver measured where statistics exist, with a named candidate spine and a boundary that is one per series · `working` (2026-09-20)
...
- [[data-sources]] — Selected fictional historical-data basis, layered state and information, and a driver measured where national statistics exist and extrapolated beyond, now tested against what is actually published · `working` (2026-09-20)
