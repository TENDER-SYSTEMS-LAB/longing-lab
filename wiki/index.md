...
- [[identification-experiment]] — The fourth round's Section 7 procedure run on the v3 world: the handover through the interaction block, a recovered count that saturates near nine, a promotion gate calibrated on a planted null, cross-market transportability, and the order's stake measured, then rerun on the v4 and v5 worlds — every reading holds on v4, and v5 shows what mixing placeholders with measurements does — no factor named · `working` (2026-09-20)
