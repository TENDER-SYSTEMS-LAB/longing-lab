...
- **Each analyst carries their own order, inside the house constraint, provisionally.** An analyst's monthly research may declare its own attribution order among the admissible ones — measured first, reflexive last — so every analyst's reading sits inside the house `Joint` band; the house ledger keeps its one order. To be corrected later against the record. `user-confirmed` (2026-09-20). See [[DEC-012-analyst-orders-inside-the-house-constraint]].
