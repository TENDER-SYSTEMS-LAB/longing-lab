...
- **Every number in the new structure.** The severity distribution's tail, forbearance before default, call intensity, wave membership and dating, the lag between arrival and substitution, which proxies are used and how three countries' statistics are normalised. None selected.
...
- `SRC-2026-09-20-bearer-bond-issuance` — **unregistered placeholder.** The 2026-09-20 conversation is not yet exported into `raw/`. Register it, record its hash, and promote [[DEC-008-bearer-bond-is-perpetual]], [[DEC-009-three-markets-and-convergence]] and [[technology-waves]] from `working` in the same task.
