...
- **Whether AI that restores a lost capacity counts as arrival, and whether substitution means execution or judgment.** The user asked on 2026-09-21 whether an ALS speech decoder runs toward more romance; the AI wave's connection coefficient was set from substitution alone. The assistant's split of one technology into two actions, its execution-versus-judgment distinction and its measurement design are `llm-proposed`, not adopted. See [[technology-waves]] and [[data-sources]].
