# LONGING Wiki — Agent Instructions

This is LONGING's long-term project memory. Shared conventions originate in [TENDER SYSTEMS](https://github.com/TENDER-SYSTEMS-LAB/tender-systems); these local instructions are sufficient for routine work. Consult the institutional repository only when shared rules or cross-project scope are at issue.
